...
# Code solutions for Extension Task 1 questions:
unique_embarked = df2['embarked'].nunique()
most_common_pclass = df2['pclass'].mode()[0]

print(f"\nUnique values in 'embarked': {unique_embarked}")
print(f"Most common passenger class (pclass): {most_common_pclass}")